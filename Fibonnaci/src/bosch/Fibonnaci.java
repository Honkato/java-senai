...
*/
    ...
    public String[] thanos (){
        String[] nomes = {"Batista", "Tejero", "Alex", "Gustavo", "Michael", "Emilly", "Naelly", "Luiza", "Grazielly", "adhayne", "Ghuilherme", "Beatriz", "Tayssa", "Macharete", "Raissa", "Radija", "Capovila", "Livia"};
        String[] nomesAux;
        String nome;
